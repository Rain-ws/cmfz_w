    ...
    $(function () {
        $("#album-show-table").jqGrid({
            ...
            colModel: [
                ...
                {name: 'starId',editable:true,edittype:"select",editoptions:{dataUrl:"${pageContext.request.contextPath}/star/selectAll"},
                    formatter:function (value, option, rows) {
                        return rows.star.nickname;
                    }},
                {name: 'cover',editable:true,align : "center",edittype :"file",formatter:function (value, option, rows) {
